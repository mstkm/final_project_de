...
with DAG(
    ...
    insert_dim_case_table = MySqlOperator(
        task_id="insert_dim_case_table",
        mysql_conn_id="mysql_conn",
        sql="sql/insert_dim_case.sql",
    )
    ...
    start >> create_stage_table >> insert_dim_case_table >> create_destination_tables >> end